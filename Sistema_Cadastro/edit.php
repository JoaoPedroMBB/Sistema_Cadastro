        ...
        <div class="row">
            <div class="col-md-12 mt-4">
                <h1 class="text-center">
                    Sistema de cadastro::Editar registro
                </h1>    
            </div>
            <div class="row">
                <div class="col-md-5 mx-auto">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="">Whatssap</label>
                            <input type="text" name="whats" value="<?php echo $row['whatssap'];?>" class="form-control" 
